...
- [20 ways to become a better node js developer](https://medium.com/@me_37286/20-ways-to-become-a-better-node-js-developer-in-2020-d6bd73fcf424)
...
- [CRUD vs CQRS](https://hackernoon.com/practical-microservices-development-patterns-crud-vs-cqrs-h6m3y5y?source=rss)
...
### Bash scripting
- [Bash scripting essentials for JS developers](https://itnext.io/bash-scripting-essentials-for-javascript-developers-ffef92afba2c)

### Best Practices
- [node best practices](https://github.com/goldbergyoni/nodebestpractices#1-project-structure-practices)
- [Node js in production](https://goldbergyoni.com/checklist-best-practice-of-node-js-in-production/)

### Buffers
- [Buffers in Node](https://www.digitalocean.com/community/tutorials/using-buffers-in-node-js)

### CLI
- [Libraries to build a CLI](https://dev.to/yvonnickfrin/7-libraries-to-build-node-js-cli-3jc7)
...
### Hosting 
- [5 ways to host zour app](https://amitbend.com/node.js/2019/05/13/five-free-ways-to-host-your-node-app-2019)
- [App Engine](https://medium.com/faun/app-engine-getting-started-f9daed776371)
...
- [Performance Monitoring](https://pages.nodesource.com/guide-performance-monitoring-nodejs-nodeweekly.html)

### Native
- [How to call C/C++ from Node](https://medium.com/@tarkus/how-to-call-c-c-code-from-node-js-86a773033892)
...
### Swagger
- [Handling API validation](https://medium.com/@Scampiuk/handling-api-validation-with-openapi-swagger-documents-in-nodejs-1f09c133d4d2)

### Workers
- [Threads in node js](https://blog.logrocket.com/a-complete-guide-to-threads-in-node-js-4fa3898fe74f/)
...
### Typescript
- [Typescript with Node](https://blog.sourcerer.io/a-crash-course-on-typescript-with-node-js-2c376285afe1)
